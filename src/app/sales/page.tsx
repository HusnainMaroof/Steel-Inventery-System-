...
export default function SalesPage() {
  const { sales, customers, inventory, products, categories, attributeDefs, addSale, addPayment, addCustomer, deleteSale, salePaid } = useStore();
  ...
  useEffect(() => {
    ...
    if (new URLSearchParams(window.location.search).get("tab") === "print") setTab("print");
  }, []);
